# [⌂](../README.md) › [Windows](../README.md#windows) › [GUID shortcuts](guids.md) › Archive
...
| Account Pictures         | `shell:::{008CA0B1-55B4-4C56-B8A8-4DE4B299D3BE}` | `%APPDATA%\Microsoft\Windows\AccountPictures`                                         |
| Administrative Tools     | `shell:::{724EF170-A42D-4FEF-9F26-B60E846FBA4F}` | `%APPDATA%\Microsoft\Windows\Start Menu\Programs\Administrative Tools`                |
| Administrative Tools     | `shell:::{D0384E7D-BAC3-4797-8F14-CBA229B392B5}` | `%ALLUSERSPROFILE%\Microsoft\Windows\Start Menu\Programs\Administrative Tools`        |
| AppDataDesktop           | `shell:::{B2C5E279-7ADD-439F-B28C-C41FE1BBF672}` | `%LOCALAPPDATA%\Desktop`                                                              |
| AppDataDocuments         | `shell:::{7BE16610-1F7F-44AC-BFF0-83E15F2FFCA1}` | `%LOCALAPPDATA%\Documents`                                                            |
| AppDataFavorites         | `shell:::{7CFBEFBC-DE1F-45AA-B843-A542AC536CC9}` | `%LOCALAPPDATA%\Favorites`                                                            |
| AppDataProgramData       | `shell:::{559D40A3-A036-40FA-AF61-84CB430A4D34}` | `%LOCALAPPDATA%\ProgramData`                                                          |
| Application Shortcuts    | `shell:::{A3918781-E5F2-4890-B3D9-A7E54332328C}` | `%LOCALAPPDATA%\Microsoft\Windows\Application Shortcuts`                              |
| Applications             | `shell:::{1E87508D-89C2-42F0-8A7E-645A0F50CA58}` | _virtual folder_                                                                      |
| Camera Roll              | `shell:::{767E6811-49CB-4273-87C2-20F355E1085B}` | `%USERPROFILE%\OneDrive\Pictures\Camera Roll`                                         |
| Camera Roll              | `shell:::{AB5FB87B-7CE2-4F83-915D-550846C9537B}` | `%USERPROFILE%\Pictures\Camera Roll`                                                  |
| Common Files             | `shell:::{6365D5A7-0F0D-45E5-87F6-0DA56B6A4F7D}` | `%ProgramFiles%\Common Files`                                                         |
| Common Files             | `shell:::{DE974D24-D9C6-4D3E-BF91-F4455120B917}` | `%ProgramFiles%\Common Files`                                                         |
| Common Files             | `shell:::{F7F1ED05-9F6D-47A2-AAAE-29D317C6F066}` | `%ProgramFiles%\Common Files`                                                         |
| Computer                 | `shell:::{0AC0837C-BBF8-452A-850D-79D08E667CA7}` | _virtual folder_                                                                      |
| Conflicts                | `shell:::{4BFEFB45-347D-4006-A5BE-AC0CB0567192}` | _virtual folder_                                                                      |
| Contacts                 | `shell:::{56784854-C6CB-462B-8169-88E350ACB882}` | `%USERPROFILE%\Contacts`                                                              |
| Control Panel            | `shell:::{82A74AEB-AEB4-465C-A014-D097EE346D63}` | _virtual folder_                                                                      |
| Cookies                  | `shell:::{2B0F765D-C0E9-4171-908E-08A611B84FF6}` | `%APPDATA%\Microsoft\Windows\Cookies`                                                 |
| Desktop                  | `shell:::{B4BFCC3A-DB2C-424C-B029-7FE99A87C641}` | `%USERPROFILE%\Desktop`                                                               |
| DeviceMetadataStore      | `shell:::{5CE4A5E9-E4EB-479D-B89F-130C02886155}` | `%ALLUSERSPROFILE%\Microsoft\Windows\DeviceMetadataStore`                             |
